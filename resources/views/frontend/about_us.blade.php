            ...
            <div class="col-lg-6 col-xl-6 wow fadeInLeft" data-wow-delay="200ms">
                <div class="why-choose-two__content">
                    <div class="sec-title text-left">
                        ...
                        <h2 class="sec-title__title">@lang('translation.elon_farm_in_vn')</h2>
                        <!-- /.sec-title__title -->
                    </div><!-- /.sec-title -->
            ...
            <div class="col-xl-4">
                <div class="destination-two__content">
                    <div class="sec-title text-left">
                        ...
                        <h2 class="sec-title__title">@lang('translation.welcome_to_homestay')</h2>
                        <!-- /.sec-title__title -->
                    </div><!-- /.sec-title -->
                    <!-- /.sec-title -->
                ...
                <div class="trevlo-stretch-element-inside-column">
                    <div class="destination-two__carousel trevlo-owl__carousel trevlo-owl__carousel--basic-nav trevlo-owl__carousel--with-shadow owl-theme owl-carousel"
                        ...
                        <div class="item">
                            <div class="destination-two__card">
                                <div class="destination-two__card-img-box destination-two__card-img-box--round">
                                    <img src="/assets/frontend/images/about/destination-2-2.png" alt="destination"
                                    ...
                                    <div class="destination-two__card-overlay destination-two__card-overlay--round">
                                        <a href="/assets/frontend/images/about/destination-2-2.png"
                        ...
                        <div class="item">
                            <div class="destination-two__card">
                                <div class="destination-two__card-img-box destination-two__card-img-box--circle">
                                    <img src="/assets/frontend/images/about/destination-2-3.png" alt="destination"
                                    ...
                                    <div class="destination-two__card-overlay destination-two__card-overlay--circle">
                                        <a href="/assets/frontend/images/about/destination-2-3.png"
                                            class="destination-two__card-plus img-popup"><span
                                                class="icon-plus"></span></a>
                                    </div><!-- /.destination-two__card-overlay destination-two__card-overlay--circle -->
                                </div><!-- /.destination-two__card-img-box -->
                                <div class="destination-two__card-title-box">
                                    <h4 class="destination-two__card-title"><a href="javascript:void(0)">Tranquil</a>
                                    </h4>
                                </div><!-- /.destination-two__card-title-box -->
                            </div><!-- /.destination-two__card -->
                        </div>
                        <div class="item">
                            <div class="destination-two__card">
                                <div class="destination-two__card-img-box destination-two__card-img-box--round">
                                    <img src="/assets/frontend/images/about/destination-2-4.png" alt="destination"
                                        class="destination-two__card-img destination-two__card-img--round">
                                    <div class="destination-two__card-overlay destination-two__card-overlay--round">
                                        <a href="/assets/frontend/images/about/destination-2-4.png"
                                            class="destination-two__card-plus img-popup"><span
                                                class="icon-plus"></span></a>
                                    </div><!-- /.destination-two__card-overlay destination-two__card-overlay--round -->
                                </div><!-- /.destination-two__card-img-box -->
                        ...
                        <div class="item">
                            <div class="destination-two__card">
                                <div class="destination-two__card-img-box destination-two__card-img-box--circle">
                                    <img src="/assets/frontend/images/about/destination-2-5.png" alt="destination"
                                        class="destination-two__card-img destination-two__card-img--circle">
                                    <div class="destination-two__card-overlay destination-two__card-overlay--circle">
                                        <a href="/assets/frontend/images/about/destination-2-5.png"
                                            class="destination-two__card-plus img-popup"><span
                                                class="icon-plus"></span></a>
                                    </div><!-- /.destination-two__card-overlay destination-two__card-overlay--circle -->
                                </div><!-- /.destination-two__card-img-box -->
                        ...
                        {{--<div class="item">
                                <div class="destination-two__card">
                                    <div class="destination-two__card-img-box destination-two__card-img-box--round">
                                        ...
                                        <div class="destination-two__card-overlay destination-two__card-overlay--round">
                                            <a href="assets/frontend/images/about/destination-2-6.png" class="destination-two__card-plus img-popup"><span class="icon-plus"></span></a>
                                        </div><!-- /.destination-two__card-overlay destination-two__card-overlay--round -->
                                    </div><!-- /.destination-two__card-img-box -->
                                    <div class="destination-two__card-title-box">
                            ...
                            <div class="item">
                                <div class="destination-two__card">
                                    <div class="destination-two__card-img-box destination-two__card-img-box--circle">
                                        <img src="assets/frontend/images/about/destination-2-7.png" alt="destination" class="destination-two__card-img destination-two__card-img--circle">
                                        <div class="destination-two__card-overlay destination-two__card-overlay--circle">
                                            <a href="assets/frontend/images/about/destination-2-7.png" class="destination-two__card-plus img-popup"><span class="icon-plus"></span></a>
                                        </div><!-- /.destination-two__card-overlay destination-two__card-overlay--circle -->
                                    </div><!-- /.destination-two__card-img-box -->
                                    <div class="destination-two__card-title-box">
                            ...
                            <div class="item">
                                <div class="destination-two__card">
                                    <div class="destination-two__card-img-box destination-two__card-img-box--round">
                                        <img src="assets/frontend/images/about/destination-2-8.png" alt="destination" class="destination-two__card-img destination-two__card-img--round">
                                        <div class="destination-two__card-overlay destination-two__card-overlay--round">
                                            <a href="assets/frontend/images/about/destination-2-8.png" class="destination-two__card-plus img-popup"><span class="icon-plus"></span></a>
                                        </div><!-- /.destination-two__card-overlay destination-two__card-overlay--round -->
                                    </div><!-- /.destination-two__card-img-box -->
                                    <div class="destination-two__card-title-box">
                            ...
                            <div class="item">
                                <div class="destination-two__card">
                                    <div class="destination-two__card-img-box destination-two__card-img-box--circle">
                                        <img src="assets/frontend/images/about/destination-2-9.png" alt="destination" class="destination-two__card-img destination-two__card-img--circle">
                                        <div class="destination-two__card-overlay destination-two__card-overlay--circle">
                                            <a href="assets/frontend/images/about/destination-2-9.png" class="destination-two__card-plus img-popup"><span class="icon-plus"></span></a>
                                        </div><!-- /.destination-two__card-overlay destination-two__card-overlay--circle -->
                                    </div><!-- /.destination-two__card-img-box -->
                                    <div class="destination-two__card-title-box">
                            ...
                            <div class="item">
                                <div class="destination-two__card">
                                    <div class="destination-two__card-img-box destination-two__card-img-box--round">
                                        <img src="assets/frontend/images/about/destination-3.0.png" alt="destination" class="destination-two__card-img destination-two__card-img--round">
                                        <div class="destination-two__card-overlay destination-two__card-overlay--round">
                                            <a href="assets/frontend/images/about/destination-3.0.png" class="destination-two__card-plus img-popup"><span class="icon-plus"></span></a>
                                        </div><!-- /.destination-two__card-overlay destination-two__card-overlay--round -->
                                    </div><!-- /.destination-two__card-img-box -->
                                    <div class="destination-two__card-title-box">
                            ...
                            <div class="item">
                                <div class="destination-two__card">
                                    <div class="destination-two__card-img-box destination-two__card-img-box--circle">
                                        <img src="assets/frontend/images/about/destination-3.1.png" alt="destination" class="destination-two__card-img destination-two__card-img--circle">
                                        <div class="destination-two__card-overlay destination-two__card-overlay--circle">
                                            <a href="assets/frontend/images/about/destination-3.1.png" class="destination-two__card-plus img-popup"><span class="icon-plus"></span></a>
                                        </div><!-- /.destination-two__card-overlay destination-two__card-overlay--circle -->
                                    </div><!-- /.destination-two__card-img-box -->
                                    <div class="destination-two__card-title-box">
                            ...
                            <div class="item">
                                <div class="destination-two__card">
                                    <div class="destination-two__card-img-box destination-two__card-img-box--round">
                                        <img src="assets/frontend/images/about/destination-3.2.png" alt="destination" class="destination-two__card-img destination-two__card-img--round">
                                        <div class="destination-two__card-overlay destination-two__card-overlay--round">
                                            <a href="assets/frontend/images/about/destination-3.2.png" class="destination-two__card-plus img-popup"><span class="icon-plus"></span></a>
                                        </div><!-- /.destination-two__card-overlay destination-two__card-overlay--round -->
                                    </div><!-- /.destination-two__card-img-box -->
                                    <div class="destination-two__card-title-box">
                            ...
                            <div class="item">
                                <div class="destination-two__card">
                                    <div class="destination-two__card-img-box destination-two__card-img-box--circle">
                                        <img src="assets/frontend/images/about/destination-3.3.png" alt="destination" class="destination-two__card-img destination-two__card-img--circle">
                                        <div class="destination-two__card-overlay destination-two__card-overlay--circle">
                                            <a href="assets/frontend/images/about/destination-3.3.png" class="destination-two__card-plus img-popup"><span class="icon-plus"></span></a>
                                        </div><!-- /.destination-two__card-overlay destination-two__card-overlay--circle -->
                                    </div><!-- /.destination-two__card-img-box -->
                                    <div class="destination-two__card-title-box">
                ...
                <div class="row">
                        ...
                        <div class="counter-box @@extraClassName">
                            ...
                            <div class="counter-box__inner sec-title count-box">
                                <h3 class="counter-box__count-text counter-box__count-text--one sec-title__heading count-text"
                                    data-stop="115" data-speed="1500">00</h3>
                    ...
                    <div class="col-xl-3 col-lg-3 col-6 wow animated fadeInUp" data-wow-delay="0.3s"
                        ...
                        <div class="counter-box @@extraClassName">
                            ...
                            <div class="counter-box__inner sec-title count-box">
                                <h3 class="counter-box__count-text counter-box__count-text--one sec-title__heading count-text"
                                    data-stop="2" data-speed="1500">00</h3>
                                <h3 class="counter-box__count-text sec-title__heading">k</h3>
                            </div><!-- /.counter-box__inner -->
                    ...
                    <div class="col-xl-3 col-lg-3 col-6 wow animated fadeInUp" data-wow-delay="0.5s"
                        ...
                        <div class="counter-box @@extraClassName">
                            ...
                            <div class="counter-box__inner sec-title count-box">
                                <h3 class="counter-box__count-text counter-box__count-text--one sec-title__heading count-text"
                                    data-stop="98.2" data-speed="1500">00</h3>
                    ...
                    <div class="col-xl-3 col-lg-3 col-6 wow animated fadeInUp" data-wow-delay="0.7s"
                        ...
                        <div class="counter-box counter-box--no-border">
                            ...
                            <div class="counter-box__inner sec-title count-box">
                                <h3 class="counter-box__count-text counter-box__count-text--one sec-title__heading count-text"
                                    data-stop="10" data-speed="1500">00</h3>
                                <h3 class="counter-box__count-text sec-title__heading">+</h3>
                            </div><!-- /.counter-box__inner -->
...
<section class="guide-one section-space-bottom">
    <div class="container">
        ...
        <div>
            <iframe
                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3905.160006674467!2d108.33790847594491!3d11.824064988395646!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3171415c4a847499%3A0x3bac5cf6af75a94a!2sElon%20Farm!5e0!3m2!1svi!2s!4v1737520075800!5m2!1svi!2s"
            ...
            <div class="guide-one__item">
                <div class="guide-single">
                    <div class="guide-single__image-box">
                        <img src="assets/frontend/images/about/about-us-<?php echo $i; ?>.png"
                            alt="About Us Image <?php echo $i; ?>" class="guide-single__image" loading="lazy">
                    </div>
                </div>
            </div>
            <?php endfor; ?>
