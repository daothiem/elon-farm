...
@section('content')
    <div class="card rounded-3">
        <div class="card-header d-flex justify-content-between align-items-center">
            ...
            <a href="/admin/them-moi/nhan-vien" class="btn btn-dark waves-effect waves-light w-sm pt-2 pb-2">Thêm mới</a>
        </div>
    </div>
                ...
                <div class="table-responsive table-card mt-3 mb-1">
                    <table class="table align-middle table-nowrap" id="customerTable">
                        ...
                        <tr>
                            ...
                            <th  data-sort="customer_name">Tên nhân viên</th>
                            <th  data-sort="customer_name">Vị trí công tác</th>
                            <th  data-sort="phone">Số điện thoại</th>
                            <th  data-sort="date">Vị trí</th>
                        ...
                        @foreach($data as $index => $item)
                            <tr>
                                ...
                                <td class="customer_name">{{ $item->phoneNumber }}</td>
                                <td class="customer_name">{{ $item->ordering}}</td>
                                <td>
                                    <div class="d-flex gap-2">
                                        <div class="edit">
                                            <button onclick="window.location='/admin/{{$item->id}}/nhan-vien'" class="btn btn-sm btn-success edit-item-btn" >Cập nhật</button>
                                        </div>
                                        <div class="remove">
                                            <button
                                                value="{{ $item->id }}"
    ...
    <script>
        $(document).ready(function () {
            ...
            $('#delete-record').click(function () {
                ...
                form.attr('action', '/admin/'+ item_id+'/nhan-vien');
                form.submit();
            });
        })
    </script>
