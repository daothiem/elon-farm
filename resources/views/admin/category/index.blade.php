...
@section('content')
    ...
    <div class="card mt-2">
        <div class="card-body">
            <div id="customerList">
                <form action="/admin/danh-muc" method="get">
                    <div class="form-search row align-items-center row-gap-3">
                        ...
                        <div class="col-6 col-md-4 d-flex align-items-center gap-3">
                            <label for="root_id" class="form-label" style="clear: both; display: inline-block; white-space: nowrap;">Phân loại sp </label>
                ...
                <div class="table-responsive table-card mt-3 mb-1">
                    <table class="table align-middle table-nowrap" id="customerTable">
                        ...
                        <tr>
                            ...
                            <th  data-sort="phone">Phân loại sản phẩm</th>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex gap-2">
                                        <div class="edit">
                                            <button onclick="window.location='/admin/{{$item->id}}/danh-muc'" class="btn btn-sm btn-success edit-item-btn" >Cập nhật</button>
                                        </div>
                                        <div class="remove">
                                            <button
                                                value="{{ $item->id }}"
