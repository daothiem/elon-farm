                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-2">
                                    <div class="form-check form-switch form-switch-md mb-3 text-center d-flex flex-column align-items-start p-0" dir="ltr">
                                        <label class="form-label" for="news-index">Tin Nổi bật</label>
                                        <input type="checkbox" style="left: 0 !important;" class="form-check-input m-0" @if(isset($news) && $news->is_hot) checked @endif name="is_hot" id="news-index">
                                    </div>
                                </div>
                            </div>
                            <div class="mb-3">
