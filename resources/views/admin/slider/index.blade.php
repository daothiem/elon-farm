...
@section('content')
    <div class="card rounded-3">
        <div class="card-header d-flex justify-content-between align-items-center">
            <h6 class="mb-0">Danh sách slider</h6>
            <a href="/admin/them-moi/sliders" class="btn btn-dark waves-effect waves-light w-sm pt-2 pb-2">Thêm mới</a>
        </div>
    </div>
                    ...
                    <div class="form-search row align-items-center row-gap-3">
                        <div class="col-12 col-md-4 d-flex align-items-center gap-3">
                            ...
                            @foreach(request()->query() as $key => $value)
                                ...
                                @endif
                            @endforeach
                            <input class="form-control" value="@if(isset($input['name'])){{$input['name']}}@endif" placeholder="Nhập tên slider" name="name" id="search-name"/>
                        </div>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex gap-2">
                                        <div class="edit">
                                            <button onclick="window.location='/admin/{{$item->id}}/sliders'" class="btn btn-sm btn-success edit-item-btn" >Cập nhật</button>
                                        </div>
                                        <div class="remove">
                                            <button
                                                value="{{ $item->id }}"
    ...
    <script>
        $(document).ready(function () {
            ...
            $('#delete-record').click(function () {
                ...
                form.attr('action', '/admin/'+ item_id+'/slider');
                form.submit();
            });
        })
    </script>
