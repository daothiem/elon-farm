...
@section('content')
    <div class="card rounded-3">
        <div class="card-header d-flex justify-content-between align-items-center">
            ...
            <a href="/admin/them-moi/dich-vu" class="btn btn-dark waves-effect waves-light w-sm pt-2 pb-2">Thêm mới</a>
        </div>
    </div>
    ...
    <div class="card mt-2">
        <div class="card-body">
            <div id="customerList">
                <form action="/admin/dich-vu" method="get">
                    <div class="form-search row align-items-center row-gap-3">
                        <div class="col-5 col-md-4 d-flex align-items-center gap-3">
                            ...
                            @foreach(request()->query() as $key => $value)
                                ...
                                @endif
                            @endforeach
                            <input class="form-control" value="@if(isset($input['name'])){{$input['name']}}@endif" placeholder="Nhập tên danh mục" name="name" id="search-name"/>
                        </div>
                ...
                <div class="table-responsive table-card mt-3 mb-1">
                    <table class="table align-middle table-nowrap" id="customerTable">
                        ...
                        <tr>
                            <th >#</th>
                            <th  data-sort="customer_name">Tên dịch vụ</th>
                            <th  data-sort="customer_name">Url</th>
                            <th  data-sort="address">Loại dịch vụ</th>
                            <th  data-sort="phone">Thứ tự</th>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex gap-2">
                                        <div class="edit">
                                            <button onclick="window.location='/admin/{{$item->id}}/dich-vu'" class="btn btn-sm btn-success edit-item-btn" >Cập nhật</button>
                                        </div>
                                        <div class="remove">
                                            <button
                                                    value="{{ $item->id }}"
    ...
    <script>
        $(document).ready(function () {
            ...
            $('#delete-record').click(function () {
                ...
                form.attr('action', '/admin/'+ item_id+'/dich-vu');
                form.submit();
            });
        })
    </script>
