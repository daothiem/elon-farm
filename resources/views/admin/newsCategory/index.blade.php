...
<div class="card mt-2">
    <div class="card-body">
        <form action="/admin/danh-muc-tin-tuc" method="get">
            <div class="form-search row align-items-end">
                <div class="col-12 col-md-4 d-flex align-items-center gap-3">
                    ...
                    <input class="form-control" value="@if(isset($input['name'])){{$input['name']}}@endif" placeholder="Nhập tiêu đề danh mục tin tức" name="name" id="search-name"/>
                </div>
            ...
            <div class="table-responsive table-card mt-3 mb-1">
                <table class="table align-middle table-nowrap" id="customerTable">
                    ...
                    <tr>
                        ...
                        <th  data-sort="phone">Danh mục cha</th>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="d-flex gap-2">
                                    <div class="edit">
                                        <button onclick="window.location='/admin/{{$item->id}}/danh-muc-tin-tuc'" class="btn btn-sm btn-success edit-item-btn" >Cập nhật</button>
                                    </div>
                                    <div class="remove">
                                        <button
                                            value="{{ $item->id }}"
