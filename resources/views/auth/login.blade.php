                    ...
                    <div class="text-center mt-sm-5 mb-4 text-white-50">
                        <div>
                            <a href="/admin" class="d-inline-block auth-logo">
                                <img src="{{ asset('images/LOGO-website.png') }}" alt="" width="200" height="200">
                            </a>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card mt-4">
                        ...
                        <div class="card-body p-4">
                            <div class="text-center mt-2">
                                ...
                                <p class="text-muted">Đăng nhập để sử dụng hệ thông.</p>
                            </div>
                            <div class="p-2 mt-4">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="text-center">
                        <p class="mb-0 text-muted">&copy; <script>document.write(new Date().getFullYear())</script> Design & Develop  <i class="mdi mdi-heart text-danger"></i> by DMC media</p>
                    </div>
                </div>
            </div>
        </div>
