...
<?php $__env->slot('li_1'); ?> Trang chủ <?php $__env->endSlot(); ?>
<?php $__env->slot('title'); ?> Trang chủ <?php $__env->endSlot(); ?>
                            ...
                            <div class="d-flex align-items-end justify-content-between mt-4">
                                <div>
                                    <h4 class="fs-22 fw-bold ff-secondary text-white mb-4"><span
                                            class="counter-value" data-target="<?php echo e($countProduct); ?>">0</span> Tours
                                    </h4>
                    ...
                    <div class="card card-animate bg-success">
                        <div class="card-body">
                            ...
                            <div class="d-flex align-items-end justify-content-between mt-4">
                                <div>
                                    <h4 class="fs-22 fw-bold ff-secondary text-white mb-4"><span
                                            class="counter-value" data-target="<?php echo e($blogCount); ?>">0</span> Blogs
                                    </h4>
                    ...
                    <div class="card card-animate bg-info">
                        <div class="card-body">
                            ...
                            <div class="d-flex align-items-end justify-content-between mt-4">
                                <div>
                                    <h4 class="fs-22 fw-bold ff-secondary text-white mb-4"><span
                                            class="counter-value" data-target="<?php echo e($staffCount); ?>">0</span> Nhân viên
                                    </h4>
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/thiemdao/Desktop/project/elon-farm/resources/views/admin/index.blade.php ENDPATH**/ ?>