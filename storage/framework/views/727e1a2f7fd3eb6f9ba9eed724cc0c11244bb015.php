...
<div class="app-menu navbar-menu">
    ...
    <div class="navbar-brand-box">
        ...
        <a href="/admin" class="logo logo-dark">
            <span class="logo-sm">
                <img src="<?php echo e(URL::asset($about_us->logo_mobile)); ?>" alt="" height="22">
            </span>
            <span class="logo-lg">
                 <img src="<?php echo e(URL::asset($about_us->logo_pc)); ?>" alt="" height="50">
            </span>
        </a>
        <!-- Light Logo-->
...
<?php /**PATH /Users/thiemdao/Desktop/project/elon-farm/resources/views/admin/layouts/sidebar.blade.php ENDPATH**/ ?>